...
export class PantryApp {
  ...
  /**
   * Aplica cierres locales de hojas inferiores sin ejecutar reglas de negocio.
   *
   * @param {string} action Accion de cierre.
   * @returns {boolean} Si la accion fue gestionada.
   */
